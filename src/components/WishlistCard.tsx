...
function RowActions() {
  return (
    <div className="grid grid-cols-3 divide-x divide-border border-t border-border">
      <button aria-label="Remove" className="flex justify-center py-2.5">
        <Trash2 className="h-[18px] w-[18px] text-foreground" />
      </button>
      <button className="flex items-center justify-center gap-1.5 py-2.5 text-[14px] font-bold text-primary">
        <ShoppingBag className="h-[18px] w-[18px]" /> Add
      </button>
      <button aria-label="Share" className="flex justify-center py-2.5">
